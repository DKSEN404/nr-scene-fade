...
export function initDefaultPresets() {
  ...
  registerPreset('netrunner', {
    ...
    rawContent: [
      ...
      '<div style="max-width:960px;width:92%;padding:40px 50px;border:1px solid rgba(0,255,65,.2);box-shadow:0 0 25px rgba(0,255,65,.06),inset 0 0 25px rgba(0,255,65,.03);background:rgba(0,10,0,.92)">',
      '<div class="hg">',
  ...
  registerPreset('combat', {
    ...
    rawContent: [
      ...
      '<div style="max-width:960px;width:92%;padding:40px 50px;border:1px solid rgba(255,32,32,.25);box-shadow:0 0 25px rgba(255,32,32,.08),inset 0 0 20px rgba(255,32,32,.04);background:rgba(10,0,0,.92);animation:danger-flash 4s ease-in-out infinite">',
      '<div class="tm">',
  ...
  registerPreset('mystery', {
    ...
    rawContent: [
      ...
      '<div style="max-width:960px;width:92%;padding:40px 50px;border:1px solid rgba(176,128,255,.18);box-shadow:0 0 30px rgba(176,128,255,.05),inset 0 0 30px rgba(176,128,255,.03);background:rgba(5,0,8,.92);animation:sigil-glow 6s ease-in-out infinite">',
  ...
  registerPreset('road', {
    ...
    rawContent: [
      ...
      '<div style="max-width:960px;width:92%;padding:40px 50px;border:1px solid rgba(255,170,0,.2);box-shadow:0 0 25px rgba(255,170,0,.06),inset 0 0 25px rgba(255,170,0,.03);background:rgba(10,5,0,.92);animation:road-glow 5s ease-in-out infinite">',
      '<div class="rd">',
  ...
  registerPreset('afterlife', {
    ...
    rawContent: [
      ...
      '<div style="max-width:960px;width:92%;padding:45px 55px;border:1px solid rgba(255,0,255,.2);box-shadow:0 0 30px rgba(255,0,255,.06),inset 0 0 30px rgba(255,0,255,.03);background:rgba(5,0,5,.92);animation:club-glow 3s ease-in-out infinite">',
      '<div class="ae">',
